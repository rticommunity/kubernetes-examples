...
|[6. Peer-to-Peer Communications Between External Applications Behind Cone NATs](external_peer_to_peer/) | Enable peer-to-peer communication with participants outside the cluster using NodePort and RTI Cloud Discovery Service. | NodePort Service, StatefulSet, Deployment, ConfigMap | RTI DDS Ping, RTI CDS |
