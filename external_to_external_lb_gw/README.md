...
`$ rtiddsping -qosFile rwt_pub_participant.xml -qosProfile RWT_Demo::RWT_Profile -publisher -domainId 100`

`$ rtiddsping -qosFile rwt_sub_participant.xml -qosProfile RWT_Demo::RWT_Profile -subscriber -domainId 100`
