...
kubectl create secret docker-registry regcred --namespace=hello-from-outside --docker-server=docker.io --docker-username=rtiresearch --docker-password=rti.research.23.docker --docker-email=research_docker@rti.com
