...
void run_publisher_application(unsigned int domain_id, unsigned int sample_count)
{
    ...
    dds::pub::DataWriter<PatientMonitoring> writer(publisher, topic);
    ...
    samples_written++) {
        ...
        std::cout << "Writing PatientMonitoring, count " << samples_written << std::endl;

        PatientMonitoring data(std::to_string(samples_written));
